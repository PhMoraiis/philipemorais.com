...
const projectSchema = z.object({
	...
	translatedShortDescription: z
		.string()
		.min(3, 'A descrição longa é obrigatória'),
...
const ProjectsDashboard = () => {
	...
	// 	if (data.image && data.image !== currentProject.image)
	// 		updatedFields.image = data.image
	// 	if (data.imageMobile && data.imageMobile !== currentProject.imageMobile)
	// 		updatedFields.imageMobile = data.imageMobile
	// 	if (data.imageDark && data.imageDark !== currentProject.imageDark)
	// 		updatedFields.imageDark = data.imageDark
	// 	if (
	// 		data.imageDarkMobile &&
	// 		data.imageDarkMobile !== currentProject.imageDarkMobile
	// 	)
	// 		updatedFields.imageDarkMobile = data.imageDarkMobile
	// 	if (
	// 		data.shortDescription &&
	// 		data.shortDescription !== currentProject.shortDescription
	// 	)
	// 		updatedFields.shortDescription = data.shortDescription
	// 	if (
	// 		data.translatedShortDescription &&
	// 		data.translatedShortDescription !==
	// 			currentProject.translatedShortDescription
	// 	)
	// 		updatedFields.translatedShortDescription = data.translatedShortDescription
	// 	if (data.href && data.href !== currentProject.href)
	// 		updatedFields.href = data.href
	// 	if (data.status && data.status !== currentProject.status)
	// 		updatedFields.status = data.status
	// 	if (data.techs && !arraysEqual(data.techs, currentProject.techs))
	// 		updatedFields.techs = data.techs
	...
	// 					? error.message
	// 					: 'Ocorreu um erro ao tentar editar o projeto. Por favor, tente novamente.',
	// 			icon: <X className='mr-2 h-4 w-4 text-red-500' />,
	// 			duration: 2000,
	// 		})
	// 	}
	...
	// 			description:
	// 				'Ocorreu um erro ao tentar excluir o projeto. Por favor, tente novamente.',
	// 			icon: <X className='mr-2 h-4 w-4 text-red-500' />,
	// 			duration: 2000,
	// 		})
	// 	}
										...
										<div className='mx-auto w-full max-w-sm'>
											...
											>
												...
												<div className='space-y-2'>
													...
													<Input
														{...register('translatedShortDescription')}
														id='translatedShortDescription'
														name='translatedShortDescription'
