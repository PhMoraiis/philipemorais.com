      ...
      <div className="text-center flex items-start justify-center flex-col w-full gap-y-2 mx-12">
        ...
        <div className="flex items-center justify-between mx-8 gap-4">
          ...
          <div className="flex flex-col text-left">
            <h1 className="text-dark-100 dark:text-light-100 font-relative lg:max-w-2xl xxl:text-2xl text-md">{author}</h1>
            <h6 className="text-light-700 dark:text-palette-400 font-relative lg:max-w-2xl xxl:text-2xl text-md">{position}</h6>
          </div>
        </div>
        <div className="flex items-center justify-between px-8 mt-6 w-full">
          <motion.button
            ...
            className="dark:text-light-300 text-dark-100 dark:bg-light-900 border-[1px] border-palette-300 dark:border-none hover:text-dark-100 dark:hover:text-dark-100 hover:bg-light-400 dark:hover:bg-light-100 ease-in-out rounded-full px-2 py-2"
            onClick={prevComment}>
            <ChevronLeft size={28} />
          </motion.button>
          <motion.button
