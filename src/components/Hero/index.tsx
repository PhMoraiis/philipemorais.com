    ...
    <section
      ...
      <div className="mt-20 md:flex md:items-end md:justify-between lg:flex lg:items-end lg:justify-between">
        ...
        <div
          ...
          <span className="font-RelativeBk text-gray-400 mb-1 lg:text-lg animate-shine bg-[linear-gradient(110deg,#939393,45%,#1e2631,55%,#939393)] bg-[length:200%_100%] text-transparent bg-clip-text">Available for work:</span>
