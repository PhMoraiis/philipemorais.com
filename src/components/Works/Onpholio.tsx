...
const Works = ({ className, ...props }: CardProps) => {
  ...
  const imageBG = {
    backgroundImage: `url(${isDark ? '/images/OnSubDark.webp' : '/images/OnSubLight.webp'})`,
  ...
  const mobileImageBG = {
    backgroundImage: `url(${isDark ? '/images/OnSubMobileDark.webp' : '/images/OnSubMobileLight.webp'})`,
    backgroundSize: 'cover',
    backgroundPosition: 'center',
    borderRadius: '0.75rem',
    border: 'none'
  ...
  const handleGoOnSub = () => {
    window.open('https://github.com/PhMoraiis/onsub', '_blank')
  }
  ...
  return (<>
    <Card onClick={handleGoOnSub} className={cn('w-full md:w-full md:h-[330px] lg:w-full lg:h-[380px] h-[550px] shadow-xl rounded-xl cursor-pointer hidden sm:flex', className)} {...props} style={imageBG}>
      <CardHeader>
        <CardTitle className='text-black dark:text-primary'>OnSub</CardTitle>
        <CardDescription className='text-black dark:text-primary'>{t('OnSubDescription')}</CardDescription>
      </CardHeader>
    ...
    <Card
      ...
      style={mobileImageBG}
      {...props}
      onClick={handleGoOnSub}
    >
      <CardHeader>
        <CardTitle className='text-black dark:text-primary'>OnSub</CardTitle>
        <CardDescription>{t('OnSubDescription')}</CardDescription>
      </CardHeader>
